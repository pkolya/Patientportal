...
wb=openpyxl.load_workbook('D:/OrthoASC/source/OrthoASC_03_InsertSafeSurgeryChecklist (1).xlsx')
ws=wb.active
cols=ws.max_column
...
for x in range(0,len(onerow)):
    ...
    print(onerow[x])
    print(ws.max_row)
wb.save('D:/OrthoASC/Results/OrthoASC_03_InsertSafeSurgeryChecklist (1).xlsx')
...
wb.save('D:/OrthoASC/Results/OrthoASC_03_InsertSafeSurgeryChecklist_Results.xlsx')
